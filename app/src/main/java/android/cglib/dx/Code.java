...
import static android.cglib.dx.rop.code.Rop.BRANCH_GOTO;
import static android.cglib.dx.rop.code.Rop.BRANCH_NONE;
import static android.cglib.dx.rop.code.Rop.BRANCH_RETURN;
import static android.cglib.dx.rop.type.Type.BT_BYTE;
import static android.cglib.dx.rop.type.Type.BT_CHAR;
import static android.cglib.dx.rop.type.Type.BT_INT;
import static android.cglib.dx.rop.type.Type.BT_SHORT;

import android.cglib.dx.rop.code.BasicBlockList;
import android.cglib.dx.rop.code.Insn;
import android.cglib.dx.rop.code.PlainCstInsn;
import android.cglib.dx.rop.code.PlainInsn;
import android.cglib.dx.rop.code.RegisterSpecList;
import android.cglib.dx.rop.code.Rop;
import android.cglib.dx.rop.code.Rops;
import android.cglib.dx.rop.code.SourcePosition;
import android.cglib.dx.rop.code.ThrowingCstInsn;
import android.cglib.dx.rop.code.ThrowingInsn;
import android.cglib.dx.rop.cst.CstInteger;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(android.cglib.dx.rop.type.Type sourceType,
                           android.cglib.dx.rop.type.Type targetType) {
